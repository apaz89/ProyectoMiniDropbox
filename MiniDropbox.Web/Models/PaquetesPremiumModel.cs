...
namespace MiniDropbox.Web.Models
{
    ...
    {
        [Required]
        [StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long and maximum {1} characters long",
            MinimumLength = 6)]
        [Display(Name = "Nombre del Paquete")]
        public string NombrePaquete { get; set; }

        [StringLength(200, ErrorMessage = "The {0} must be at least {2} characters long and maximum {1} characters long",
            MinimumLength = 25)]
